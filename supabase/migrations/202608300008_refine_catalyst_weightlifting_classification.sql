-- Catalyst's General section contains a small number of lift-specific support
-- movements. Preserve the source grouping, but classify these as Weightlifting
-- in Lift Log so their identity and logging defaults match the movement.

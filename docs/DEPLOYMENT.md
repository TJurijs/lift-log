...
- The active nonprod release is `/srv/liftlog/nonprod/releases/20260825T211411Z` (application commit `e509d58`). `/srv/liftlog/nonprod/releases/20260825T123226Z` remains the verified rollback target.

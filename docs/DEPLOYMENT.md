...
- The active nonprod release is `/srv/liftlog/nonprod/releases/20260826T001343Z` (application commit `e438bf3`). `/srv/liftlog/nonprod/releases/20260825T211411Z` remains the verified rollback target.

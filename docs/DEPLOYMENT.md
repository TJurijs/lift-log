...
- The active nonprod release is `/srv/liftlog/nonprod/releases/20260824T234303Z` (application commit `5b5511b`). `/srv/liftlog/nonprod/releases/20260824T233658Z` remains the verified rollback target.

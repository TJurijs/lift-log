...
- The active nonprod release is `/srv/liftlog/nonprod/releases/20260902T001738Z` (application commit `0507717`). `/srv/liftlog/nonprod/releases/20260830T000344Z` remains the frontend rollback target.

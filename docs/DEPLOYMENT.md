...
- The active nonprod release is `/srv/liftlog/nonprod/releases/20260825T102028Z` (application commit `006c238`). `/srv/liftlog/nonprod/releases/20260824T234303Z` remains the verified rollback target.

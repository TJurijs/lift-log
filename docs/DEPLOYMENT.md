...
- The active nonprod release is `/srv/liftlog/nonprod/releases/20260827T191720Z` (application commit `58e4406`). `/srv/liftlog/nonprod/releases/20260826T001343Z` remains the verified rollback target.

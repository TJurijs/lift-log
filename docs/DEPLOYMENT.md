...
- The active nonprod release is `/srv/liftlog/nonprod/releases/20260821T095330Z` (application commit `6d20606`). The preceding `/srv/liftlog/nonprod/releases/20260820T224319Z` remains available for rollback.

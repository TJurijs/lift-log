...
- The active nonprod release is `/srv/liftlog/nonprod/releases/20260825T123226Z` (application commit `1e36ea9`). `/srv/liftlog/nonprod/releases/20260825T102028Z` remains the verified rollback target.

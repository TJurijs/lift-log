...
- The active nonprod release is `/srv/liftlog/nonprod/releases/20260822T001246Z` (application commit `622f99f`). The preceding `/srv/liftlog/nonprod/releases/20260821T095330Z` remains available for rollback.
